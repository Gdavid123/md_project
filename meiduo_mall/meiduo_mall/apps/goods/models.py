...
class Goods(BaseModel):
    ...
    desc_pack = models.CharField(max_length=50, verbose_name='规格与包装',null=True)
    desc_detail = models.CharField(max_length=50, verbose_name='商品详情', null=True)
    desc_service = models.CharField(max_length=50, verbose_name='售后服务', null=True)
